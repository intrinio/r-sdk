...
InstitutionalHolding <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`cusip`, `ticker`, `security_name`, `security_type`, `title_of_class`, `stock_exchange`, `filing_date`, `value`, `amount`, `type`, `investment_discretion`, `other_manager`, `sole_voting_authority`, `shared_voting_authority`, `no_voting_authority`){
      if (!missing(`cusip`)) {
        self$`cusip` <- `cusip`
      }
      if (!missing(`ticker`)) {
