...
ApiResponseSecurityTrueStrengthIndex <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseSecurityTrueStrengthIndexJson) {
      ApiResponseSecurityTrueStrengthIndexObject <- jsonlite::fromJSON(ApiResponseSecurityTrueStrengthIndexJson)
      self$`technicals` <- lapply(ApiResponseSecurityTrueStrengthIndexObject$`technicals`, function(x) TrueStrengthIndexTechnicalValue$new()$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE)))
      TechnicalIndicatorObject <- TechnicalIndicator$new()
      self$`indicator` <- TechnicalIndicatorObject$fromJSON(jsonlite::toJSON(ApiResponseSecurityTrueStrengthIndexObject$indicator, auto_unbox = TRUE))
      SecuritySummaryObject <- SecuritySummary$new()
      self$`security` <- SecuritySummaryObject$fromJSON(jsonlite::toJSON(ApiResponseSecurityTrueStrengthIndexObject$security, auto_unbox = TRUE))
      self$`next_page` <- ApiResponseSecurityTrueStrengthIndexObject$`next_page`
    }
  )
)
