...
ApiResponseSecurityAccumulationDistributionIndex <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseSecurityAccumulationDistributionIndexJson) {
      ApiResponseSecurityAccumulationDistributionIndexObject <- jsonlite::fromJSON(ApiResponseSecurityAccumulationDistributionIndexJson, simplifyDataFrame = FALSE)
      self$setFromList(ApiResponseSecurityAccumulationDistributionIndexObject)
    },
