...
FundamentalSummary <- R6::R6Class(
  ...
  public = list(
    ...
    `is_latest` = NA,
    `updated_date` = NA,
    initialize = function(`id`, `statement_code`, `fiscal_year`, `fiscal_period`, `type`, `start_date`, `end_date`, `filing_date`, `is_latest`, `updated_date`){
      if (!missing(`id`)) {
        self$`id` <- `id`
      }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`is_latest`)) {
        ...
        if (is.list(self$`is_latest`) && ((length(self$`is_latest`) == 0) || ((length(self$`is_latest`) != 0 && R6::is.R6(self$`is_latest`[[1]]))))) {
          FundamentalSummaryObject[['is_latest']] <- lapply(self$`is_latest`, function(x) x$toJSON())
        } else {
          FundamentalSummaryObject[['is_latest']] <- jsonlite::toJSON(self$`is_latest`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`updated_date`)) {
        ...
        if (is.list(self$`updated_date`) && ((length(self$`updated_date`) == 0) || ((length(self$`updated_date`) != 0 && R6::is.R6(self$`updated_date`[[1]]))))) {
          FundamentalSummaryObject[['updated_date']] <- lapply(self$`updated_date`, function(x) x$toJSON())
        } else {
          FundamentalSummaryObject[['updated_date']] <- jsonlite::toJSON(self$`updated_date`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(FundamentalSummaryJson) {
      ...
      if (!is.null(FundamentalSummaryObject$`is_latest`)) {
        self$`is_latest` <- FundamentalSummaryObject$`is_latest`
      }
      if (!is.null(FundamentalSummaryObject$`updated_date`)) {
        self$`updated_date` <- FundamentalSummaryObject$`updated_date`
      }
    },
