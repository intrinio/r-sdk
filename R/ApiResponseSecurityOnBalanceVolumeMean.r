...
ApiResponseSecurityOnBalanceVolumeMean <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseSecurityOnBalanceVolumeMeanJson) {
      ApiResponseSecurityOnBalanceVolumeMeanObject <- jsonlite::fromJSON(ApiResponseSecurityOnBalanceVolumeMeanJson, simplifyDataFrame = FALSE)
      self$setFromList(ApiResponseSecurityOnBalanceVolumeMeanObject)
    },
