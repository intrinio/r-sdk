...
ApiResponseStockMarketIndexHistoricalData <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseStockMarketIndexHistoricalDataJson) {
      ApiResponseStockMarketIndexHistoricalDataObject <- jsonlite::fromJSON(ApiResponseStockMarketIndexHistoricalDataJson, simplifyDataFrame = FALSE)
      self$setFromList(ApiResponseStockMarketIndexHistoricalDataObject)
    },
    setFromList = function(listObject) {
      ...
      self$`index` <- StockMarketIndexSummary$new()
