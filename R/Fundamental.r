...
Fundamental <- R6::R6Class(
  ...
  public = list(
    ...
    `company` = NA,
    initialize = function(`id`, `statement_code`, `fiscal_year`, `fiscal_period`, `type`, `start_date`, `end_date`, `filing_date`, `is_latest`, `updated_date`, `first_calculable`, `earnings_disclosed_at`, `company`){
      if (!missing(`id`)) {
        self$`id` <- `id`
      }
      ...
      if (!missing(`updated_date`)) {
        self$`updated_date` <- `updated_date`
      }
      if (!missing(`first_calculable`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`updated_date`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`updated_date`) && ((length(self$`updated_date`) == 0) || ((length(self$`updated_date`) != 0 && R6::is.R6(self$`updated_date`[[1]]))))) {
          FundamentalObject[['updated_date']] <- lapply(self$`updated_date`, function(x) x$toJSON())
        } else {
          FundamentalObject[['updated_date']] <- jsonlite::toJSON(self$`updated_date`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`first_calculable`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`first_calculable`) && ((length(self$`first_calculable`) == 0) || ((length(self$`first_calculable`) != 0 && R6::is.R6(self$`first_calculable`[[1]]))))) {
          FundamentalObject[['first_calculable']] <- lapply(self$`first_calculable`, function(x) x$toJSON())
        } else {
          FundamentalObject[['first_calculable']] <- jsonlite::toJSON(self$`first_calculable`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`earnings_disclosed_at`)) {
        ...
        if (is.list(self$`earnings_disclosed_at`) && ((length(self$`earnings_disclosed_at`) == 0) || ((length(self$`earnings_disclosed_at`) != 0 && R6::is.R6(self$`earnings_disclosed_at`[[1]]))))) {
          FundamentalObject[['earnings_disclosed_at']] <- lapply(self$`earnings_disclosed_at`, function(x) x$toJSON())
        } else {
          FundamentalObject[['earnings_disclosed_at']] <- jsonlite::toJSON(self$`earnings_disclosed_at`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(FundamentalJson) {
      ...
      if (!is.null(FundamentalObject$`updated_date`)) {
        self$`updated_date` <- FundamentalObject$`updated_date`
      }
      if (!is.null(FundamentalObject$`first_calculable`)) {
        self$`first_calculable` <- FundamentalObject$`first_calculable`
      }
      if (!is.null(FundamentalObject$`earnings_disclosed_at`)) {
        self$`earnings_disclosed_at` <- FundamentalObject$`earnings_disclosed_at`
      }
    ...
    setFromList = function(listObject) {
      ...
      if (!is.null(listObject$`updated_date`)) {
        self$`updated_date` <- as.POSIXct(listObject$`updated_date`, tz = "GMT", "%Y-%m-%dT%H:%M:%OS")
      }
      else {
        self$`updated_date` <- NA 
      }
      ...
      if (!is.null(listObject$`first_calculable`)) {
        self$`first_calculable` <- as.POSIXct(listObject$`first_calculable`, tz = "GMT", "%Y-%m-%dT%H:%M:%OS")
      }
      else {
        self$`first_calculable` <- NA 
      }
    ...
    getAsList = function() {
      ...
      listObject[["updated_date"]] <- self$`updated_date`


        


      listObject[["first_calculable"]] <- self$`first_calculable`
