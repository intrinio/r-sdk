...
#'
#'
#' get_stock_exchange_price_adjustments_dividends Dividends by date for exchange
#'
#'
#' get_stock_exchange_price_adjustments_splits Splits by date for exchange
#'
#'
...
StockExchangeApi <- R6::R6Class(
  ...
  public = list(
    ...
    get_stock_exchange_price_adjustments_dividends = function(identifier, opts = list()){
      queryParams <- list()
      headerParams <- character()
      ...
      urlPath <- "/stock_exchanges/{identifier}/prices/adjustments/dividends"
      if (!missing(`identifier`)) {
        urlPath <- gsub(paste0("\\{", "identifier", "\\}"), `identifier`, urlPath)
      }
    ...
    get_stock_exchange_price_adjustments_splits = function(identifier, opts = list()){
      queryParams <- list()
      headerParams <- character()
      ...
      urlPath <- "/stock_exchanges/{identifier}/prices/adjustments/splits"
      if (!missing(`identifier`)) {
        urlPath <- gsub(paste0("\\{", "identifier", "\\}"), `identifier`, urlPath)
      }
