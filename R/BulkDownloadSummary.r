...
BulkDownloadSummary <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`id`, `name`, `format`, `data_length_bytes`, `update_frequency`, `last_updated`, `links`){
      if (!missing(`id`)) {
        self$`id` <- `id`
      }
      if (!missing(`name`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`last_updated`)) {
        ...
        if (is.list(self$`last_updated`) && ((length(self$`last_updated`) == 0) || ((length(self$`last_updated`) != 0 && R6::is.R6(self$`last_updated`[[1]]))))) {
          BulkDownloadSummaryObject[['last_updated']] <- lapply(self$`last_updated`, function(x) x$toJSON())
        } else {
          BulkDownloadSummaryObject[['last_updated']] <- jsonlite::toJSON(self$`last_updated`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(BulkDownloadSummaryJson) {
      ...
      if (!is.null(BulkDownloadSummaryObject$`last_updated`)) {
        self$`last_updated` <- BulkDownloadSummaryObject$`last_updated`
      }
    ...
    setFromList = function(listObject) {
      ...
      if (!is.null(listObject$`last_updated`)) {
        self$`last_updated` <- self$`last_updated` <- as.Date(listObject$`last_updated`, "%Y-%m-%d")
      }
      else {
