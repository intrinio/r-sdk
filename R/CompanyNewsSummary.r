...
CompanyNewsSummary <- R6::R6Class(
  ...
  public = list(
    ...
    `issuer_company` = NA,
    `issuer_security` = NA,
    initialize = function(`id`, `title`, `publication_date`, `companies`, `securities`, `url`, `summary`, `source`, `topics`, `copyright`, `language`, `word_count`, `spam`, `business_relevance`, `article_sentiment`, `article_sentiment_confidence`, `issuer`, `issuer_name`, `issuer_company`, `issuer_security`){
      if (!missing(`id`)) {
        self$`id` <- `id`
      }
      if (!missing(`title`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`companies`)) {
        ...
        if (is.list(self$`companies`) && ((length(self$`companies`) == 0) || ((length(self$`companies`) != 0 && R6::is.R6(self$`companies`[[1]]))))) {
          CompanyNewsSummaryObject[['companies']] <- lapply(self$`companies`, function(x) x$toJSON())
        } else {
          CompanyNewsSummaryObject[['companies']] <- jsonlite::toJSON(self$`companies`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`securities`)) {
        ...
        if (is.list(self$`securities`) && ((length(self$`securities`) == 0) || ((length(self$`securities`) != 0 && R6::is.R6(self$`securities`[[1]]))))) {
          CompanyNewsSummaryObject[['securities']] <- lapply(self$`securities`, function(x) x$toJSON())
        } else {
          CompanyNewsSummaryObject[['securities']] <- jsonlite::toJSON(self$`securities`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`url`)) {
        # If the object is an empty list or a list of R6 Objects
      ...
      if (!is.null(self$`issuer`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`issuer`) && ((length(self$`issuer`) == 0) || ((length(self$`issuer`) != 0 && R6::is.R6(self$`issuer`[[1]]))))) {
          CompanyNewsSummaryObject[['issuer']] <- lapply(self$`issuer`, function(x) x$toJSON())
        } else {
          CompanyNewsSummaryObject[['issuer']] <- jsonlite::toJSON(self$`issuer`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`issuer_name`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`issuer_name`) && ((length(self$`issuer_name`) == 0) || ((length(self$`issuer_name`) != 0 && R6::is.R6(self$`issuer_name`[[1]]))))) {
          CompanyNewsSummaryObject[['issuer_name']] <- lapply(self$`issuer_name`, function(x) x$toJSON())
        } else {
          CompanyNewsSummaryObject[['issuer_name']] <- jsonlite::toJSON(self$`issuer_name`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`issuer_company`)) {
        ...
        if (is.list(self$`issuer_company`) && ((length(self$`issuer_company`) == 0) || ((length(self$`issuer_company`) != 0 && R6::is.R6(self$`issuer_company`[[1]]))))) {
          CompanyNewsSummaryObject[['issuer_company']] <- lapply(self$`issuer_company`, function(x) x$toJSON())
        } else {
          CompanyNewsSummaryObject[['issuer_company']] <- jsonlite::toJSON(self$`issuer_company`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`issuer_security`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`issuer_security`) && ((length(self$`issuer_security`) == 0) || ((length(self$`issuer_security`) != 0 && R6::is.R6(self$`issuer_security`[[1]]))))) {
          CompanyNewsSummaryObject[['issuer_security']] <- lapply(self$`issuer_security`, function(x) x$toJSON())
        } else {
          CompanyNewsSummaryObject[['issuer_security']] <- jsonlite::toJSON(self$`issuer_security`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(CompanyNewsSummaryJson) {
      ...
      if (!is.null(CompanyNewsSummaryObject$`companies`)) {
        self$`companies` <- CompanyNewsSummaryObject$`companies`
      }
      if (!is.null(CompanyNewsSummaryObject$`securities`)) {
        self$`securities` <- CompanyNewsSummaryObject$`securities`
      }
      ...
      if (!is.null(CompanyNewsSummaryObject$`issuer`)) {
        self$`issuer` <- CompanyNewsSummaryObject$`issuer`
      }
      if (!is.null(CompanyNewsSummaryObject$`issuer_name`)) {
        self$`issuer_name` <- CompanyNewsSummaryObject$`issuer_name`
      }
      if (!is.null(CompanyNewsSummaryObject$`issuer_company`)) {
        self$`issuer_company` <- CompanyNewsSummaryObject$`issuer_company`
      }
      if (!is.null(CompanyNewsSummaryObject$`issuer_security`)) {
        self$`issuer_security` <- CompanyNewsSummaryObject$`issuer_security`
      }
    },
    ...
    setFromList = function(listObject) {
      ...
      if (!is.null(listObject$`issuer`)) {
        self$`issuer` <- listObject$`issuer`
      }
      else {
        self$`issuer` <- NA 
      }

      if (!is.null(listObject$`issuer_name`)) {
        self$`issuer_name` <- listObject$`issuer_name`
      }
      else {
        self$`issuer_name` <- NA 
      }
      ...
      self$`issuer_company` <- CompanySummary$new()
      self$`issuer_company`$setFromList(listObject$`issuer_company`)
      ...
      self$`issuer_security` <- SecuritySummary$new()
      self$`issuer_security`$setFromList(listObject$`issuer_security`)
    ...
    getAsList = function() {
      ...
      listObject[["issuer"]] <- self$`issuer`
      listObject[["issuer_name"]] <- self$`issuer_name`




      issuer_company_list <- self$`issuer_company`$getAsList()
      for (x in names(issuer_company_list)) {
        listObject[[paste("issuer_company_",x, sep = "")]] <- self$`issuer_company`[[x]]
      }
      ...
      issuer_security_list <- self$`issuer_security`$getAsList()
      for (x in names(issuer_security_list)) {
        listObject[[paste("issuer_security_",x, sep = "")]] <- self$`issuer_security`[[x]]
      }
