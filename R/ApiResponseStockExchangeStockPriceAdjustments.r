...
ApiResponseStockExchangeStockPriceAdjustments <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseStockExchangeStockPriceAdjustmentsJson) {
      ApiResponseStockExchangeStockPriceAdjustmentsObject <- jsonlite::fromJSON(ApiResponseStockExchangeStockPriceAdjustmentsJson)
      self$`stock_price_adjustments` <- lapply(ApiResponseStockExchangeStockPriceAdjustmentsObject$`stock_price_adjustments`, function(x) StockPriceAdjustment$new()$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE)))
      StockExchangeObject <- StockExchange$new()
      self$`stock_exchange` <- StockExchangeObject$fromJSON(jsonlite::toJSON(ApiResponseStockExchangeStockPriceAdjustmentsObject$stock_exchange, auto_unbox = TRUE))
      self$`next_page` <- ApiResponseStockExchangeStockPriceAdjustmentsObject$`next_page`
    }
  )
)
