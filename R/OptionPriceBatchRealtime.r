...
OptionPriceBatchRealtime <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`extended_price`)) {
        ...
        if (is.list(self$`extended_price`) && ((length(self$`extended_price`) == 0) || ((length(self$`extended_price`) != 0 && R6::is.R6(self$`extended_price`[[1]]))))) {
          OptionPriceBatchRealtimeObject[['extended_price']] <- lapply(self$`extended_price`, function(x) x$toJSON())
        } else {
          OptionPriceBatchRealtimeObject[['extended_price']] <- jsonlite::toJSON(self$`extended_price`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(OptionPriceBatchRealtimeJson) {
      ...
      if (!is.null(OptionPriceBatchRealtimeObject$`extended_price`)) {
        self$`extended_price` <- OptionPriceBatchRealtimeObject$`extended_price`
      }
    },
