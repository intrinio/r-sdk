...
OptionInterval <- R6::R6Class(
  ...
  public = list(
    ...
    `change` = NA,
    `trade_count` = NA,
    initialize = function(`open_time`, `close_time`, `open`, `high`, `low`, `close`, `volume`, `average`, `change`, `trade_count`){
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`trade_count`)) {
        ...
        if (is.list(self$`trade_count`) && ((length(self$`trade_count`) == 0) || ((length(self$`trade_count`) != 0 && R6::is.R6(self$`trade_count`[[1]]))))) {
          OptionIntervalObject[['trade_count']] <- lapply(self$`trade_count`, function(x) x$toJSON())
        } else {
          OptionIntervalObject[['trade_count']] <- jsonlite::toJSON(self$`trade_count`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(OptionIntervalJson) {
      ...
      if (!is.null(OptionIntervalObject$`trade_count`)) {
        self$`trade_count` <- OptionIntervalObject$`trade_count`
      }
    },
