...
ApiResponseCryptoMoneyFlowIndex <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseCryptoMoneyFlowIndexJson) {
      ApiResponseCryptoMoneyFlowIndexObject <- jsonlite::fromJSON(ApiResponseCryptoMoneyFlowIndexJson, simplifyDataFrame = FALSE)
      self$setFromList(ApiResponseCryptoMoneyFlowIndexObject)
    },
