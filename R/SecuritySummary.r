...
SecuritySummary <- R6::R6Class(
  ...
  public = list(
    ...
    `share_class_figi` = NA,
    `primary_listing` = NA,
    initialize = function(`id`, `company_id`, `exchange`, `exchange_mic`, `stock_exchange_id`, `name`, `code`, `currency`, `ticker`, `composite_ticker`, `figi`, `composite_figi`, `share_class_figi`, `primary_listing`){
      if (!missing(`id`)) {
        self$`id` <- `id`
      }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`exchange`)) {
        ...
        if (is.list(self$`exchange`) && ((length(self$`exchange`) == 0) || ((length(self$`exchange`) != 0 && R6::is.R6(self$`exchange`[[1]]))))) {
          SecuritySummaryObject[['exchange']] <- lapply(self$`exchange`, function(x) x$toJSON())
        } else {
          SecuritySummaryObject[['exchange']] <- jsonlite::toJSON(self$`exchange`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`exchange_mic`)) {
        ...
        if (is.list(self$`exchange_mic`) && ((length(self$`exchange_mic`) == 0) || ((length(self$`exchange_mic`) != 0 && R6::is.R6(self$`exchange_mic`[[1]]))))) {
          SecuritySummaryObject[['exchange_mic']] <- lapply(self$`exchange_mic`, function(x) x$toJSON())
        } else {
          SecuritySummaryObject[['exchange_mic']] <- jsonlite::toJSON(self$`exchange_mic`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`stock_exchange_id`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`stock_exchange_id`) && ((length(self$`stock_exchange_id`) == 0) || ((length(self$`stock_exchange_id`) != 0 && R6::is.R6(self$`stock_exchange_id`[[1]]))))) {
          SecuritySummaryObject[['stock_exchange_id']] <- lapply(self$`stock_exchange_id`, function(x) x$toJSON())
        } else {
          SecuritySummaryObject[['stock_exchange_id']] <- jsonlite::toJSON(self$`stock_exchange_id`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(SecuritySummaryJson) {
      ...
      if (!is.null(SecuritySummaryObject$`exchange`)) {
        self$`exchange` <- SecuritySummaryObject$`exchange`
      }
      if (!is.null(SecuritySummaryObject$`exchange_mic`)) {
        self$`exchange_mic` <- SecuritySummaryObject$`exchange_mic`
      }
      if (!is.null(SecuritySummaryObject$`stock_exchange_id`)) {
        self$`stock_exchange_id` <- SecuritySummaryObject$`stock_exchange_id`
      }
    ...
    setFromList = function(listObject) {
      ...
      if (!is.null(listObject$`stock_exchange_id`)) {
        self$`stock_exchange_id` <- listObject$`stock_exchange_id`
      }
      else {
        self$`stock_exchange_id` <- NA 
      }
    ...
    getAsList = function() {
      ...
      listObject[["stock_exchange_id"]] <- self$`stock_exchange_id`
