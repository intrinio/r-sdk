...
#' \describe{
#'
#' get8k_filing_by_id Lookup 8-K Filing
#'
#'
#' get_all8k_filings All 8-K Filings
#'
#'
...
#'
#'
#' search8k_filings Search 8-K Filings
#'
#'
#' search8k_filings_bulk Search 8-K Filings (Bulk Response)
#'
#'
...
FilingApi <- R6::R6Class(
  ...
  public = list(
    ...
    get8k_filing_by_id = function(identifier, opts = list()){
      queryParams <- list()
      headerParams <- character()

      if ('format' %in% names(opts)) {
        queryParams['format'] <- opts['format']
      }
      if ('query' %in% names(opts)) {
        queryParams['query'] <- opts['query']
      }
      urlPath <- "/filings/8K/{identifier}"
    ...
    get_all8k_filings = function(opts = list()){
      queryParams <- list()
      headerParams <- character()
      ...
      if ('item_code' %in% names(opts)) {
        queryParams['item_code'] <- opts['item_code']
      }
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        ...
        if ("ApiResponseFiling8ks" == "Numeric") {
          returnObject <- as.numeric(jsonlite::fromJSON(result))
        } else if ("ApiResponseFiling8ks" == "Integer") {
          returnObject <- as.integer(jsonlite::fromJSON(result))
        } else if ("ApiResponseFiling8ks" == "Character") {
          returnObject <- gsub("\\\"", "", result)
        } else if ("ApiResponseFiling8ks" == "Logical") {
          returnObject <- as.logical(jsonlite::fromJSON(result))
        } else {
          returnObject <- ApiResponseFiling8ks$new()
          returnObject$fromJSON(result)
        }
    ...
    search8k_filings = function(opts = list()){
      queryParams <- list()
      headerParams <- character()
      ...
      if ('document_type' %in% names(opts)) {
        queryParams['document_type'] <- opts['document_type']
      }
      if ('page_size' %in% names(opts)) {
        queryParams['page_size'] <- opts['page_size']
      }
      ...
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        ...
        if ("ApiResponseFiling8ksSummaries" == "Numeric") {
          returnObject <- as.numeric(jsonlite::fromJSON(result))
        } else if ("ApiResponseFiling8ksSummaries" == "Integer") {
          returnObject <- as.integer(jsonlite::fromJSON(result))
        } else if ("ApiResponseFiling8ksSummaries" == "Character") {
          returnObject <- gsub("\\\"", "", result)
        } else if ("ApiResponseFiling8ksSummaries" == "Logical") {
          returnObject <- as.logical(jsonlite::fromJSON(result))
        } else {
          returnObject <- ApiResponseFiling8ksSummaries$new()
          returnObject$fromJSON(result)
        }
    ...
    search8k_filings_bulk = function(opts = list()){
      queryParams <- list()
      headerParams <- character()
      ...
      urlPath <- "/filings/8K/search/bulk"
      resp <- self$apiClient$callApi(url = paste0(self$apiClient$basePath, urlPath),
                                 method = "GET",
                                 queryParams = queryParams,
                                 headerParams = headerParams,
