...
ApiResponseSecurityZacksEPSSurprises <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseSecurityZacksEPSSurprisesJson) {
      ApiResponseSecurityZacksEPSSurprisesObject <- jsonlite::fromJSON(ApiResponseSecurityZacksEPSSurprisesJson)
      self$`eps_surprises` <- lapply(ApiResponseSecurityZacksEPSSurprisesObject$`eps_surprises`, function(x) ZacksEPSSurpriseSummary$new()$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE)))
      SecuritySummaryObject <- SecuritySummary$new()
      self$`security` <- SecuritySummaryObject$fromJSON(jsonlite::toJSON(ApiResponseSecurityZacksEPSSurprisesObject$security, auto_unbox = TRUE))
      self$`next_page` <- ApiResponseSecurityZacksEPSSurprisesObject$`next_page`
    }
  )
)
