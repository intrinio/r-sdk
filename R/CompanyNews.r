...
CompanyNews <- R6::R6Class(
  ...
  public = list(
    ...
    `issuer_company` = NA,
    `issuer_security` = NA,
    initialize = function(`id`, `title`, `publication_date`, `url`, `summary`, `source`, `company`, `companies`, `securities`, `topics`, `copyright`, `language`, `word_count`, `spam`, `business_relevance`, `article_sentiment`, `article_sentiment_confidence`, `issuer`, `issuer_name`, `issuer_company`, `issuer_security`){
      if (!missing(`id`)) {
        self$`id` <- `id`
      }
      if (!missing(`title`)) {
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`companies`)) {
        ...
        if (is.list(self$`companies`) && ((length(self$`companies`) == 0) || ((length(self$`companies`) != 0 && R6::is.R6(self$`companies`[[1]]))))) {
          CompanyNewsObject[['companies']] <- lapply(self$`companies`, function(x) x$toJSON())
        } else {
          CompanyNewsObject[['companies']] <- jsonlite::toJSON(self$`companies`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`securities`)) {
        ...
        if (is.list(self$`securities`) && ((length(self$`securities`) == 0) || ((length(self$`securities`) != 0 && R6::is.R6(self$`securities`[[1]]))))) {
          CompanyNewsObject[['securities']] <- lapply(self$`securities`, function(x) x$toJSON())
        } else {
          CompanyNewsObject[['securities']] <- jsonlite::toJSON(self$`securities`, auto_unbox = TRUE)
        }
      }
      ...
      if (!is.null(self$`issuer`)) {
        ...
        if (is.list(self$`issuer`) && ((length(self$`issuer`) == 0) || ((length(self$`issuer`) != 0 && R6::is.R6(self$`issuer`[[1]]))))) {
          CompanyNewsObject[['issuer']] <- lapply(self$`issuer`, function(x) x$toJSON())
        } else {
          CompanyNewsObject[['issuer']] <- jsonlite::toJSON(self$`issuer`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`issuer_name`)) {
        ...
        if (is.list(self$`issuer_name`) && ((length(self$`issuer_name`) == 0) || ((length(self$`issuer_name`) != 0 && R6::is.R6(self$`issuer_name`[[1]]))))) {
          CompanyNewsObject[['issuer_name']] <- lapply(self$`issuer_name`, function(x) x$toJSON())
        } else {
          CompanyNewsObject[['issuer_name']] <- jsonlite::toJSON(self$`issuer_name`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`issuer_company`)) {
        ...
        if (is.list(self$`issuer_company`) && ((length(self$`issuer_company`) == 0) || ((length(self$`issuer_company`) != 0 && R6::is.R6(self$`issuer_company`[[1]]))))) {
          CompanyNewsObject[['issuer_company']] <- lapply(self$`issuer_company`, function(x) x$toJSON())
        } else {
          CompanyNewsObject[['issuer_company']] <- jsonlite::toJSON(self$`issuer_company`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`issuer_security`)) {
        ...
        if (is.list(self$`issuer_security`) && ((length(self$`issuer_security`) == 0) || ((length(self$`issuer_security`) != 0 && R6::is.R6(self$`issuer_security`[[1]]))))) {
          CompanyNewsObject[['issuer_security']] <- lapply(self$`issuer_security`, function(x) x$toJSON())
        } else {
          CompanyNewsObject[['issuer_security']] <- jsonlite::toJSON(self$`issuer_security`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(CompanyNewsJson) {
      ...
      if (!is.null(CompanyNewsObject$`companies`)) {
        self$`companies` <- CompanyNewsObject$`companies`
      }
      if (!is.null(CompanyNewsObject$`securities`)) {
        self$`securities` <- CompanyNewsObject$`securities`
      }
      ...
      if (!is.null(CompanyNewsObject$`issuer`)) {
        self$`issuer` <- CompanyNewsObject$`issuer`
      }
      if (!is.null(CompanyNewsObject$`issuer_name`)) {
        self$`issuer_name` <- CompanyNewsObject$`issuer_name`
      }
      if (!is.null(CompanyNewsObject$`issuer_company`)) {
        self$`issuer_company` <- CompanyNewsObject$`issuer_company`
      }
      if (!is.null(CompanyNewsObject$`issuer_security`)) {
        self$`issuer_security` <- CompanyNewsObject$`issuer_security`
      }
    },
