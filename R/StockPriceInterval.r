...
StockPriceInterval <- R6::R6Class(
  ...
  public = list(
    ...
    initialize = function(`time`, `open`, `close`, `high`, `low`, `volume`, `close_time`, `interval`, `average`, `change`, `bid_high`, `bid_low`, `bid_close`, `bid_open`, `bid_first_time`, `bid_last_time`, `bid_change_percent`, `ask_high`, `ask_low`, `ask_close`, `ask_open`, `ask_first_time`, `ask_last_time`, `ask_change_percent`){
      if (!missing(`time`)) {
        self$`time` <- `time`
      }
      if (!missing(`open`)) {
