...
ApiResponseSecurityMovingAverageConvergenceDivergence <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseSecurityMovingAverageConvergenceDivergenceJson) {
      ApiResponseSecurityMovingAverageConvergenceDivergenceObject <- jsonlite::fromJSON(ApiResponseSecurityMovingAverageConvergenceDivergenceJson)
      self$`technicals` <- lapply(ApiResponseSecurityMovingAverageConvergenceDivergenceObject$`technicals`, function(x) MovingAverageConvergenceDivergenceTechnicalValue$new()$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE)))
      TechnicalIndicatorObject <- TechnicalIndicator$new()
      self$`indicator` <- TechnicalIndicatorObject$fromJSON(jsonlite::toJSON(ApiResponseSecurityMovingAverageConvergenceDivergenceObject$indicator, auto_unbox = TRUE))
      SecuritySummaryObject <- SecuritySummary$new()
      self$`security` <- SecuritySummaryObject$fromJSON(jsonlite::toJSON(ApiResponseSecurityMovingAverageConvergenceDivergenceObject$security, auto_unbox = TRUE))
      self$`next_page` <- ApiResponseSecurityMovingAverageConvergenceDivergenceObject$`next_page`
    }
  )
)
