...
ApiResponseStockExchangeRealtimeStockPrices <- R6::R6Class(
  ...
  public = list(
    ...
    fromJSONString = function(ApiResponseStockExchangeRealtimeStockPricesJson) {
      ApiResponseStockExchangeRealtimeStockPricesObject <- jsonlite::fromJSON(ApiResponseStockExchangeRealtimeStockPricesJson)
      self$`stock_prices` <- lapply(ApiResponseStockExchangeRealtimeStockPricesObject$`stock_prices`, function(x) RealtimeStockPrice$new()$fromJSON(jsonlite::toJSON(x, auto_unbox = TRUE)))
      StockExchangeObject <- StockExchange$new()
      self$`stock_exchange` <- StockExchangeObject$fromJSON(jsonlite::toJSON(ApiResponseStockExchangeRealtimeStockPricesObject$stock_exchange, auto_unbox = TRUE))
      self$`next_page` <- ApiResponseStockExchangeRealtimeStockPricesObject$`next_page`
    }
  )
)
