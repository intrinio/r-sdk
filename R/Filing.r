...
#' @field word_count 
#' @field earnings_disclosed_at 
#' @field earnings_disclosed_8k_id 
#' @field earnings_8k_url 
#' @field company 
#'
...
Filing <- R6::R6Class(
  ...
  public = list(
    ...
    `industry_group` = NA,
    `word_count` = NA,
    `earnings_disclosed_at` = NA,
    `earnings_disclosed_8k_id` = NA,
    `earnings_8k_url` = NA,
    `company` = NA,
    initialize = function(`id`, `filing_date`, `accepted_date`, `period_end_date`, `report_type`, `sec_unique_id`, `filing_url`, `report_url`, `instance_url`, `industry_category`, `industry_group`, `word_count`, `earnings_disclosed_at`, `earnings_disclosed_8k_id`, `earnings_8k_url`, `company`){
      if (!missing(`id`)) {
        self$`id` <- `id`
      }
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`earnings_disclosed_at`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`earnings_disclosed_at`) && ((length(self$`earnings_disclosed_at`) == 0) || ((length(self$`earnings_disclosed_at`) != 0 && R6::is.R6(self$`earnings_disclosed_at`[[1]]))))) {
          FilingObject[['earnings_disclosed_at']] <- lapply(self$`earnings_disclosed_at`, function(x) x$toJSON())
        } else {
          FilingObject[['earnings_disclosed_at']] <- jsonlite::toJSON(self$`earnings_disclosed_at`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`earnings_disclosed_8k_id`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`earnings_disclosed_8k_id`) && ((length(self$`earnings_disclosed_8k_id`) == 0) || ((length(self$`earnings_disclosed_8k_id`) != 0 && R6::is.R6(self$`earnings_disclosed_8k_id`[[1]]))))) {
          FilingObject[['earnings_disclosed_8k_id']] <- lapply(self$`earnings_disclosed_8k_id`, function(x) x$toJSON())
        } else {
          FilingObject[['earnings_disclosed_8k_id']] <- jsonlite::toJSON(self$`earnings_disclosed_8k_id`, auto_unbox = TRUE)
        }
      }
      if (!is.null(self$`earnings_8k_url`)) {
        # If the object is an empty list or a list of R6 Objects
        if (is.list(self$`earnings_8k_url`) && ((length(self$`earnings_8k_url`) == 0) || ((length(self$`earnings_8k_url`) != 0 && R6::is.R6(self$`earnings_8k_url`[[1]]))))) {
          FilingObject[['earnings_8k_url']] <- lapply(self$`earnings_8k_url`, function(x) x$toJSON())
        } else {
          FilingObject[['earnings_8k_url']] <- jsonlite::toJSON(self$`earnings_8k_url`, auto_unbox = TRUE)
        }
      }
    ...
    fromJSON = function(FilingJson) {
      ...
      if (!is.null(FilingObject$`earnings_disclosed_at`)) {
        self$`earnings_disclosed_at` <- FilingObject$`earnings_disclosed_at`
      }
      if (!is.null(FilingObject$`earnings_disclosed_8k_id`)) {
        self$`earnings_disclosed_8k_id` <- FilingObject$`earnings_disclosed_8k_id`
      }
      if (!is.null(FilingObject$`earnings_8k_url`)) {
        self$`earnings_8k_url` <- FilingObject$`earnings_8k_url`
      }
    ...
    setFromList = function(listObject) {
      ...
      if (!is.null(listObject$`earnings_disclosed_at`)) {
        self$`earnings_disclosed_at` <- as.POSIXct(listObject$`earnings_disclosed_at`, tz = "GMT", "%Y-%m-%dT%H:%M:%OS")
      }
      else {
        self$`earnings_disclosed_at` <- NA 
      }




      if (!is.null(listObject$`earnings_disclosed_8k_id`)) {
        self$`earnings_disclosed_8k_id` <- listObject$`earnings_disclosed_8k_id`
      }
      else {
        self$`earnings_disclosed_8k_id` <- NA 
      }

      if (!is.null(listObject$`earnings_8k_url`)) {
        self$`earnings_8k_url` <- listObject$`earnings_8k_url`
      }
      else {
        self$`earnings_8k_url` <- NA 
      }
    ...
    getAsList = function() {
      ...
      listObject[["earnings_disclosed_at"]] <- self$`earnings_disclosed_at`


        
      listObject[["earnings_disclosed_8k_id"]] <- self$`earnings_disclosed_8k_id`
      listObject[["earnings_8k_url"]] <- self$`earnings_8k_url`
