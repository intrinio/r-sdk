...
[//]: # (CLASS:IntrinioSDK::ApiResponseSecurityEaseOfMovement)
...
------------ | ------------- | -------------
**technicals** | [**List of EaseOfMovementTechnicalValue**](EaseOfMovementTechnicalValue.md) |  &nbsp;
...
[//]: # (CONTAINED_CLASS:IntrinioSDK::EaseOfMovementTechnicalValue)
