...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/r/get_options_greeks_by_contract_v2)
...
response <- OptionsApi$get_options_greeks_by_contract(contract, opts)
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/r/get_options_greeks_by_ticker_v2)
