...
[//]: # (CLASS:IntrinioSDK::ApiResponseSecurityMoneyFlowIndex)
...
------------ | ------------- | -------------
**technicals** | [**List of MoneyFlowIndexTechnicalValue**](MoneyFlowIndexTechnicalValue.md) |  &nbsp;
...
[//]: # (CONTAINED_CLASS:IntrinioSDK::MoneyFlowIndexTechnicalValue)
