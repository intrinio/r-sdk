...
[//]: # (CLASS:IntrinioSDK::ApiResponseSecurityVortexIndicator)
...
------------ | ------------- | -------------
**technicals** | [**List of VortexIndicatorTechnicalValue**](VortexIndicatorTechnicalValue.md) |  &nbsp;
...
[//]: # (CONTAINED_CLASS:IntrinioSDK::VortexIndicatorTechnicalValue)
