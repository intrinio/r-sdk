...
[//]: # (CLASS:IntrinioSDK::ApiResponseSecurityDonchianChannel)
...
------------ | ------------- | -------------
**technicals** | [**List of DonchianChannelTechnicalValue**](DonchianChannelTechnicalValue.md) |  &nbsp;
...
[//]: # (CONTAINED_CLASS:IntrinioSDK::DonchianChannelTechnicalValue)
