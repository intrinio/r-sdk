...
[//]: # (CLASS:IntrinioSDK::ApiResponseSecurityMassIndex)
...
------------ | ------------- | -------------
**technicals** | [**List of MassIndexTechnicalValue**](MassIndexTechnicalValue.md) |  &nbsp;
...
[//]: # (CONTAINED_CLASS:IntrinioSDK::MassIndexTechnicalValue)
