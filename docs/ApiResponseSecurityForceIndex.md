...
[//]: # (CLASS:IntrinioSDK::ApiResponseSecurityForceIndex)
...
------------ | ------------- | -------------
**technicals** | [**List of ForceIndexTechnicalValue**](ForceIndexTechnicalValue.md) |  &nbsp;
...
[//]: # (CONTAINED_CLASS:IntrinioSDK::ForceIndexTechnicalValue)
