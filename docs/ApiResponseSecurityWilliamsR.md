...
[//]: # (CLASS:IntrinioSDK::ApiResponseSecurityWilliamsR)
...
------------ | ------------- | -------------
**technicals** | [**List of WilliamsRTechnicalValue**](WilliamsRTechnicalValue.md) |  &nbsp;
...
[//]: # (CONTAINED_CLASS:IntrinioSDK::WilliamsRTechnicalValue)
